...
void forward_network_gpu(network net)
{
    ...
    for(i = 0; i < net.n; ++i){
       ...
       // newly_modified, in order to extract features from CPU memory during prediction (see image.c and detector.c)
       if(i==net.n-3) cuda_pull_array(l.output_gpu, l.output, l.batch*l.outputs);
